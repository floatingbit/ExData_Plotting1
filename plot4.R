...
data_select2days$Voltage <- as.numeric(data_select2days$Voltage)
data_select2days$Global_reactive_power <- as.numeric(data_select2days$Global_reactive_power)
...
#Plot at pos (1,2)
plot(data_select2days$Voltage, type = "line", xlab = "", ylab = "Voltage", axes = F)
axis(1, at = 0, "Thu")
axis(1, at = nrow(data_select2days)/2, "Fri")
axis(1, at = nrow(data_select2days), "Sat")
axis(2)
...
#Plot at pos (2,2)
plot(data_select2days$Global_reactive_power, type = "line", xlab = "", ylab = "Global_reactive_power", axes = F)
axis(1, at = 0, "Thu")
axis(1, at = nrow(data_select2days)/2, "Fri")
axis(1, at = nrow(data_select2days), "Sat")
axis(2)
